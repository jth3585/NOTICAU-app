...
export const NOTICE_LIST_SELECT =
  '*, notice_meta(notice_id, topic, action, deadline_at, target_grades, target_depts, target_campuses, target_enrollment_status, targets_freshmen, excludes_undergrad), sources(parser_key, name)';
